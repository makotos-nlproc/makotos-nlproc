＊　採用関連でご高覧の方
- 前職の業務態上、職務経歴書記載のプロジェクトのソースコードは公開しておりません
- 部分的な公開はプライベートでの共有は検討可能ですのでご相談ください
- コーディングテストは喜んでお引き受けさせていただきます
- 競技プログラミングのソースコードはAtCoder上の提出よりご確認ください（アカウント名：ms22nvmbr）
